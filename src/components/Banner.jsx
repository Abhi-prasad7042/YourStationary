    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="flex flex-col-reverse md:flex-row items-center justify-between p-6 md:p-12">
        ...
        <div className="text-left md:w-1/2 w-full mb-6 md:mb-0">
          ...
          <p className="text-lg sm:text-xl mb-6">Discover an exquisite range of stationery products tailored for every need. Shop online and elevate your writing experience!</p>
          ...
          <p className="mt-4 text-base sm:text-lg">⭐⭐⭐⭐⭐ 4.5 / 5 (<span className='text-[#D388F8]'>Based on 150 Reviews</span>)</p>
        </div>
